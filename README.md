...
Inspired by oxEdit by [Arius-Scripts](https://github.com/Arius-Scripts) (for ox_inventory). This is an independent reimplementation targeting the VORP framework with direct database access.
